<?php
	...
	define('SITE_NAME' , "TUKU MOBIL SHOP");
	...
	define('APP_ID',"1fc434bb2608b823546cb54d11854d1f");
	...
	define('DB_PASSWORD','');
	define('DB_NAME','db_tukumobilshop');
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['nama_lengkap'] : null ));
	define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['buat_username'] : null ));
